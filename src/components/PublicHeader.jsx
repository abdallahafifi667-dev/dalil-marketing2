...
const PublicHeader = () => {
  ...
  return (
    <header className={`fixed top-0 inset-x-0 h-20 z-[1000] transition-all duration-300 ${isAuthPage ? 'bg-transparent' : 'glass border-b border-white/10 shadow-lg'} px-4 md:px-8 flex justify-between items-center`}>
      {/* Left: Logo or Back */}
      <div className="flex items-center gap-4">
        {isAuthPage ? (
          ...
          >
            <div className="w-16 h-16 bg-[var(--surface-color)] rounded-[24px] flex items-center justify-center shadow-xl border border-slate-100 dark:border-white/5">
