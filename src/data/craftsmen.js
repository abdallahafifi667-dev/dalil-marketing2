...
export const craftsmen = Array.from({ length: 120 }).map((_, index) => {
  ...
  const lastName = names[Math.floor(Math.random() * names.length)];
    ...
    const unsplashIds = [
        ...
        '1581091226825-a6a2a5aee158', '1581092160562-40aa08e78837', '1581092921461-7d6560b64447'
    ];
    ...
    const finalPortfolio = [...craftSpecificPortfolio, ...userImages].sort(() => 0.5 - Math.random());
